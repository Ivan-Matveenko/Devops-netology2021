...
4 задание доработка -  Уникальность для столбца в таблице может дать ограничение подробнее об ограниченях 
-
5.4.3. Уникальные ограничения в докуументации - выбрать ограничения можно исходя из ситуации . - https://www.postgresql.org/docs/current/ddl-constraints.html

4.1 Новый бекап

root@lix:/# docker exec -it 645ff23657ec bash
root@645ff23657ec:/# cd /var/lib/postgresql
root@645ff23657ec:/var/lib/postgresql# cd data
root@645ff23657ec:/var/lib/postgresql/data# pg_dump -U selectel -d test_database>test_database_dump.
root@645ff23657ec:/var/lib/postgresql/data# ls
...
pg_hba.conf   pg_replslot    pg_subtrans   pg_xact      test_database_dump.sq
root@645ff23657ec:/var/lib/postgresql/data#
