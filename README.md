...
Ответ:
19:50:27 ivan@upc(0):~/devops-netology/go$ go version
...
Результат работы:
        9:52:56 ivan@upc(0):~/devops-netology/go$ go run conv.go
...
Результат работы:
        19:56:43 ivan@upc(0):~/devops-netology/go$ go run find.go
...
Результат работы:
        19:57:11 ivan@upc(0):~/devops-netology/go$ go run three.go
        0 -> 3, 6, 9, 
        10 -> 12, 15, 18, 
        20 -> 21, 24, 27, 30, 
        30 -> 33, 36, 39, 
