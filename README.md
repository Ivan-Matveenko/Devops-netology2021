...
-----------------------
export HISTSIZE=2000 - переменная  HISTSIZE устанавливает длину журнала - можно так изменить вывод команды history используя переменную export
...
В каких сценариях использования применимы скобки {} -   применять данные скобки можно в любых сценариях (скриптах) 
-------------------------- 
Основываясь на предыдущем вопросе, как создать однократным вызовом touch 100000 файлов? А получилось ли создать 300000? -да получиться и то и то. даже вот такое [10000000000]
-------------------------
...
vagrant@vagrant:/bin$ cp bash /tmp/new_bash
vagrant@vagrant:/bin$ cd /tmp
vagrant@vagrant:/tmp$ ls
new_bash
systemd-private-26128e7a18444d63b41e9f7437730d0d-systemd-logind.service-HBi2jh
systemd-private-26128e7a18444d63b41e9f7437730d0d-systemd-resolved.service-PTmQaj
vagrant@vagrant:/tmp$ cd new_bash
vagrant@vagrant:/tmp/new_bash$ ls
bash
